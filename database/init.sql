...
-- 插入示例线索（剧本1：古宅惊魂）
INSERT INTO `clue` (`script_id`, `parent_id`, `name`, `type`, `content`, `resource_url`, `unlock_password`, `unlock_hint`, `is_public`, `level`, `sort_order`) VALUES
(1, 0, '初始线索：一封遗书', 1, '死者书房中发现一封遗书，上面写着：\"我知道你们的秘密，今晚一切都将了结。\"', NULL, NULL, NULL, 1, 1, 1),
(1, 0, '线索：带血的匕首', 2, '一把沾有血迹的匕首，被丢弃在花园的花丛中', 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=blood%20dagger%20murder%20weapon%20dark%20background&image_size=square', NULL, NULL, 1, 1, 2),
(1, 1, '隐藏线索：日记残页', 1, '日记上写着：\"三月十五，她终于说出了真相。原来那孩子...\"后面的内容被撕掉了。', NULL, '19350315', '想想故事发生的年代，月份和日期的格式...', 0, 2, 1),
(1, 2, '隐藏线索：匕首上的指纹', 2, '经过仔细观察，匕首上有一枚清晰的指纹，指纹的小指侧有一道疤痕', 'https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=fingerprint%20on%20dagger%20close%20up%20forensic&image_size=square', '管家', '想想谁会有这样的特征...', 0, 2, 2),
(1, 3, '终极线索：真相大白', 1, '原来，大小姐林雪才是真正的凶手。她发现母亲是被继母害死的，于是策划了这场复仇...', NULL, '真相', '一切水落石出之时...', 0, 3, 1);
